      ...
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-white mb-4">
            Let's Work <span className="text-transparent bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text">Together</span>
          </h2>
            ...
            <div className="space-y-8">
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {contactLinks.map((link, index) => (
                  <div 
                    key={index} 
                    className="glass-hover cursor-pointer rounded-2xl p-6 hover:scale-105 transition-all duration-300 group relative overflow-hidden"
                    onClick={() => link.href !== '#' && window.open(link.href, '_blank')}
                  >
                    {/* Gradient overlay */}
                    <div className={`absolute inset-0 bg-gradient-to-br ${link.gradient} opacity-30 group-hover:opacity-50 transition-opacity`}></div>
                    ...
                    <div className="relative z-10">
                      <div className="flex items-center space-x-4">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-white/60 mb-1">{link.description}</p>
                          <p className={`text-sm font-medium ${link.iconColor}`}>{link.value}</p>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div className="glass rounded-2xl p-6 neon-glow-purple">
                <h4 className="font-semibold text-purple-400 mb-4">Currently Available For:</h4>
