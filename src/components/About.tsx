      ...
      <div className="container mx-auto px-6">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-white mb-16">
            About <span className="text-transparent bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text">Me</span>
          </h2>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <p className="text-lg text-white/80 leading-relaxed">
                  I'm a passionate React developer with 4+ years of experience building modern, 
                ...
                <p className="text-lg text-white/80 leading-relaxed">
                  My journey in tech started with a Computer Science degree, and I've since worked 
                  with startups and established companies, contributing to products used by thousands 
                  of users. I'm always eager to learn new technologies and best practices.
                </p>
                
                <p className="text-lg text-white/80 leading-relaxed">
                  When I'm not coding, you can find me contributing to open source projects, 
                  writing technical blogs, or exploring the latest in web development. I believe 
                  in writing clean, maintainable code and collaborating effectively with 
                  cross-functional teams.
                </p>
                
                <div className="grid grid-cols-2 gap-8 pt-6">
                  <div className="glass rounded-xl p-4">
                    <h3 className="font-semibold text-cyan-400 mb-2">Based in</h3>
                    <p className="text-white/70">San Francisco, CA</p>
                  </div>
                  <div className="glass rounded-xl p-4">
                    <h3 className="font-semibold text-cyan-400 mb-2">Experience</h3>
                    <p className="text-white/70">4+ Years</p>
                  </div>
                  <div className="glass rounded-xl p-4">
                    <h3 className="font-semibold text-cyan-400 mb-2">Focus</h3>
                    <p className="text-white/70">Frontend & Full-Stack</p>
                  </div>
                  <div className="glass rounded-xl p-4 neon-glow">
                    <h3 className="font-semibold text-cyan-400 mb-2">Available</h3>
                    <p className="text-cyan-300 font-medium">Open to opportunities</p>
                  </div>
                </div>
              </div>
