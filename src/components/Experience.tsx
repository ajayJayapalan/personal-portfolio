  ...
  const experiences = [
    {
      ...
      period: "2022 - Present",
      type: "Full-time",
      description: "Leading frontend development for a SaaS platform serving 50K+ users. Architecting and implementing scalable React applications with modern tooling.",
      achievements: [
    ...
    },
    {
      ...
      period: "2021 - 2022",
      type: "Full-time",
      description: "Developed and maintained multiple client projects ranging from e-commerce platforms to corporate websites. Collaborated with designers and backend teams.",
      achievements: [
      ...
      technologies: ["React", "JavaScript", "Sass", "Webpack", "REST APIs", "Firebase"],
    ...
    },
    {
      ...
      period: "2020 - 2021",
      type: "Full-time",
      description: "Started my professional journey building user interfaces for various startup projects. Gained experience in agile development and cross-functional collaboration.",
      achievements: [
    ...
    },
    {
      ...
      period: "2019 - 2020",
      type: "Internship",
      description: "Summer internship focused on learning React fundamentals and contributing to client projects under senior developer mentorship.",
      achievements: [
      ...
      <div className="container mx-auto px-6">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-center text-white mb-4">
            Professional <span className="text-transparent bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text">Experience</span>
          </h2>
          <p className="text-center text-white/70 mb-16 max-w-2xl mx-auto">
            4+ years of progressive growth in frontend development, from intern to senior developer, 
              ...
              <div key={index} className="relative mb-16 last:mb-0 group">
                ...
                <div className={`ml-20 md:ml-0 md:w-1/2 ${index % 2 === 0 ? 'md:pr-16' : 'md:ml-auto md:pl-16'}`}>
                  <div className="glass rounded-2xl p-8 hover:scale-105 transition-all duration-500 relative overflow-hidden">
                    {/* Gradient overlay */}
                    <div className={`absolute inset-0 bg-gradient-to-br ${exp.gradient} opacity-30 group-hover:opacity-50 transition-opacity`}></div>
                      ...
                      <div className="mb-6">
                        ...
                        <ul className="space-y-2">
                          {exp.achievements.map((achievement, achIndex) => (
                            <li key={achIndex} className="text-sm text-white/70 flex items-start">
